...
return function()
	it("should be able to import from ReplicatedStorage", function()
	...
	it("should be able to import relative", function()
		local result = import("../Logger")
		expect(result).to.equal(script.Parent.Logger)
	end)
	it("should be able to import via variables", function()
